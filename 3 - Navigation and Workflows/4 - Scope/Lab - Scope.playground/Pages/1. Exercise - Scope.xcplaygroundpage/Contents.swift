...
// Uncommenting the line above will generate a compiler error because `foo` is declared inside of the for loop, and therefore is out of scope at the second print statement.
...
// Since `x` is declared before the for loop, its scope encompasses code both inside and outside of the loop.
