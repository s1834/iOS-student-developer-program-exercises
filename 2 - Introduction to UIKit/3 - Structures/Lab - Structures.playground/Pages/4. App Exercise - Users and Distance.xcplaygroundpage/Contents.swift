...
var isabelle = User(name: "Isabelle", age: 17, height: 66, weight: 125, activityLevel: 6)
print("My name is \(isabelle.name). I am \(isabelle.age), weigh \(isabelle.weight) lbs and am \(isabelle.height) inches tall. On an activity scale from 1-10 I am probably a \(isabelle.activityLevel).")
